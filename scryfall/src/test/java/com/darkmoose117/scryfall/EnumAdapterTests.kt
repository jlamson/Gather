...
class EnumAdapterTests {
    ...
    fun `should load defaults for all Card enums`() {
        val card: Card = moshi.adapter(Card::class.java).fromJson(cardJsonWithBadEnums)!!
        assertEquals(BorderColor.NotHandled, card.borderColor)
        assertEquals(setOf(Color.Red, Color.White, Color.NotHandled), card.colorIdentity)
//        assertEquals(Component.NotHandled, card.)
    }
    
}

val cardJsonWithBadEnums: String = """{
      "object": "card",
      ...
      "layout": "transform",
      "highres_image": true,
      "image_status": "fooBlahSomethingBad",
      "cmc": 5.0,
      "component": ""fooBlahSomethingBad", 
      ...
      "collector_number": "5",
      "digital": false,
      "rarity": "fooBlahSomethingBad",
      "card_back_id": "0aeebaf5-8c7d-4636-9e82-8c27447861f7",
      "artist": "James Ryman",
      "artist_ids": [
        "3852bbc9-11c0-4fe3-8722-a06ad7e2bcc5"
      ],
      "border_color": "fooBlahSomethingBad",
      "frame": "fooBlahSomethingBad",
      "frame_effects": [
        "fooBlahSomethingBad"
      ],
      "full_art": false,
