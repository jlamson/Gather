...
/**
 * Taken from OWL sample in Google's Jetpack Compose Sample.
 *
 * [link](https://github.com/android/compose-samples/blob/main/Owl/app/src/main/java/com/example/owl/ui/onboarding/Onboarding.kt#L239)
 */
@Composable
fun StaggeredGrid(
